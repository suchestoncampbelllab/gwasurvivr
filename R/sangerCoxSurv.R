...
#' @param inter.term character(1) string giving the column name of the covariate that will be added to the interaction term with SNP (e.g. term*SNP). See details.
#' @param print.covs character(1) string of either `"only"`, `"all"` or `"some"`, defining which covariate statistics should be printed to the output. See details.
