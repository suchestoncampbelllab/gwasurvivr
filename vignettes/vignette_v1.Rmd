...
# Introduction
This package provides a workflow for how to use imputed data GWAS data from either IMPUTE2 or the Michigan imputation server and conduct survival analysis. 
